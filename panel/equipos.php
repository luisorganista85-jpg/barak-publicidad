...
<div class="content">
    ...
    <div class="acciones-top">
        <form method="GET" class="buscador">
            <input type="text" name="buscar" placeholder="Buscar equipo..." value="<?php echo $buscar; ?>">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    |
                    <a href="?eliminar=<?php echo $mostrar['id']; ?>" onclick="return confirm('¿Eliminar equipo?')">Eliminar</a>
                </td>
            </tr>
            <?php } ?>
            </tbody>
    ...
    <div class="modal-contenido">
        ...
        <?php if($equipo_editar){ ?>
            ...
            <form method="POST">
                ...
                <input type="text" name="nombre" value="<?php echo $equipo_editar['nombre']; ?>" required>
                <input type="text" name="descripcion" value="<?php echo $equipo_editar['descripcion']; ?>">
                <select name="estado">
                    ...
                    <option value="Inactivo" <?php if($equipo_editar['estado']=='Inactivo') echo 'selected'; ?>>Inactivo</option>
                </select>
        ...
        <?php } else { ?>
            ...
            <form method="POST">
                ...
                <button type="submit" name="guardar">Guardar Equipo</button>
            </form>
        <?php } ?>
    </div>
</div>
