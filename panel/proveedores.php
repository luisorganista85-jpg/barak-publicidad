...
if(isset($_POST['guardar'])){
    ...
    mysqli_query($conexion, "INSERT INTO proveedores (nombre, telefono, correo, direccion, productos) VALUES ('$nombre','$telefono','$correo','$direccion','$productos')");
...
if(isset($_GET['eliminar'])){
    $id = $_GET['eliminar'];
    mysqli_query($conexion, "DELETE FROM proveedores WHERE id='$id'");
    header("Location: proveedores.php");
    exit();
}
...
if(isset($_POST['editar'])){
    ...
    $direccion = $_POST['direccion'];
    $productos = $_POST['productos'];
    mysqli_query($conexion, "UPDATE proveedores SET nombre='$nombre', telefono='$telefono', correo='$correo', direccion='$direccion', productos='$productos' WHERE id='$id'");
    header("Location: proveedores.php");
    exit();
}
...
<div class="content">
    ...
    <div class="tabla-reciente">
        ...
        <table>
            ...
            <?php
            if($buscar != ""){
                $sql = "SELECT * FROM proveedores WHERE nombre LIKE '%$buscar%' ORDER BY id DESC";
            } else {
            ...
            <tr>
                ...
                <td>
                    <a href="?editar=<?php echo $mostrar['id']; ?>">Editar</a>
                    |
                    <a href="?eliminar=<?php echo $mostrar['id']; ?>" onclick="return confirm('¿Eliminar proveedor?')">Eliminar</a>
                </td>
            </tr>
            <?php } ?>
            </tbody>
    ...
    <div class="modal-contenido">
        ...
        <?php if($proveedor_editar){ ?>
            ...
            <form method="POST">
                ...
                <input type="text" name="direccion" value="<?php echo $proveedor_editar['direccion']; ?>">
        ...
        <?php } else { ?>
            ...
            <form method="POST">
                ...
                <input type="text" name="productos" placeholder="Vinil, lona, canvas, tintas, marcos...">
