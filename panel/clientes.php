...
if(isset($_POST['guardar'])){
    ...
    $sql = "INSERT INTO clientes (nombre, telefono, correo, empresa, direccion) VALUES ('$nombre','$telefono','$correo','$empresa','$direccion')";
...
<div class="content">
    ...
    <div class="tabla-reciente">
        ...
        <table>
            ...
            <?php
            if($buscar != ""){
                $sql = "SELECT * FROM clientes WHERE nombre LIKE '%$buscar%' OR empresa LIKE '%$buscar%' OR telefono LIKE '%$buscar%' ORDER BY id DESC";
            } else {
            ...
            <tr>
                ...
                <td>
                    ...
                    |
                    <a href="?eliminar=<?php echo $mostrar['id']; ?>" onclick="return confirm('¿Eliminar cliente?')">Eliminar</a>
                </td>
            </tr>
            <?php } ?>
            </tbody>
